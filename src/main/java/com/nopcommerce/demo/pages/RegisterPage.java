...
public class RegisterPage extends Utility {
    ...
    public String getRegisterText() {
        ...
        log.info("Get registerText : " + registerText.getText().toString());
        return message;
    }
    ...
    public void enterEmail(String email) {
        ...
        log.info("Enter Email : " + email + " to "+emailField.toString());
    }

    public void enterPassword(String password) {
        sendTextToElement(passwordField, password);
        log.info("Enter Email : " + password + " to "+passwordField.toString());
    }

    public void enterConfirmPassword(String confPassword) {
        sendTextToElement(confirmPasswordField, confPassword);
        log.info("confirm password : " + confPassword + " to "+confirmPasswordField.toString());
    }

    public void clickOnRegisterButton() {
        log.info("Clicking on : "+ registerBtn.toString());
